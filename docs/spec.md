...
- "Reconhecimento com baixa confiança" (RF-25) é definido como: nenhum candidato a preço válido foi encontrado **e/ou** nenhuma linha sobrou como candidata a nome após filtrar ruído — ou seja, equivale funcionalmente a uma falha de leitura. Esse caso é diferente da extração parcial (RF-24), que não é tratada como falha.
